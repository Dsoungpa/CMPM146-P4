...
pyhop.declare_operators (op_punch_for_wood, op_craft_wooden_axe_at_bench, op_wooden_axe_for_wood, op_craft_bench, op_craft_planks, op_craft_sticks)
...
def produce (state, ID, item):
	if item == 'wood': 
		if(state.wooden_axe[ID] >= 1 or state.wood[ID] >= 3):
			return[('produce_axeWood', ID)]
...
pyhop.declare_methods ('produce_axeWood', axe_for_wood)
pyhop.declare_methods ('produce_wooden_axe', craft_wooden_axe_at_bench)
pyhop.declare_methods ('produce_plank', craft_planks)
pyhop.declare_methods ('produce_stick', craft_sticks)
